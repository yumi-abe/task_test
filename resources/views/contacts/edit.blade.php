                    ...
                    <div class="container px-5  mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="radio" id="name" name="gender" value="0" @if($contact->gender === 0) checked @endif>男性
                                <input type="radio" id="name" name="gender" value="1" @if($contact->gender === 1) checked @endif>女性
